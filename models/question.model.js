 ...
 * a better data structure for this situation since it allows
 * for flexibility and there are efficient ways to query array in
 * MongoDB:
...
// Define the 'QuestionSchema' to be used to specify the
// compilation of the Question Model below
